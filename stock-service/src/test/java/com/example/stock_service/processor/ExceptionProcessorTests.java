...
public class ExceptionProcessorTests {
  ...
  @Test
  void testProcess_WhenStockNotAvailableException_ShouldReturnCorrectErrorResponse()
      throws Exception {
  ...
  @Test
  void testProcess_WhenInvalidStockAvailableException_ShouldReturnCorrectErrorResponse()
      throws Exception {
